...
Chinatown05Scene::Chinatown05Scene()
{
...

	{
		Material* const material =
			MaterialBuilder::BuildDefault2DMaterial(
				eRenderPriorityType::Opqaue, L"Default", eResTexture::Map_Chinatown05_spr_chinatown_loop_parallax_1);
...

	{
		Material* const material =
			MaterialBuilder::BuildDefault2DMaterial(
				eRenderPriorityType::Opqaue, L"Default", eResTexture::Map_Chinatown05_spr_chinatown_loop_parallax_2);
...

	{
		...
		obj->GetComponent<Transform>()->SetScale(3.6f, 3.6f, 1.f);
