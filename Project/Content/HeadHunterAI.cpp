...
void HeadHunterAI::CreateAnimation()
{
    ...
    anim->CreateAnimation(L"TakeOutRifle", atlas, 8, XMUINT2(5, 2580), XMUINT2(38, 43), XMUINT2(10, 10), XMINT2(3, 0), 0.08f);
    anim->CreateAnimation(L"PutBackRifle", atlas, 8, XMUINT2(5, 2016), XMUINT2(38, 43), XMUINT2(10, 10), XMINT2(3, 0), 0.08f);
    ...
    anim->CreateAnimation(L"Shoot", atlas, 8, XMUINT2(5, 2272), XMUINT2(68, 46), XMUINT2(10, 10), XMINT2(19, 1), 0.1f);
    ...
    anim->CreateAnimation(L"spr_headhunter_jump", atlas, 1, XMUINT2(5, 3953), XMUINT2(27, 44), XMUINT2(10, 10), XMINT2(0, 0), 0.125f);
